...
function generate_product_listing($product_listing) {
 ...
 return sprintf($product_listing_template, $product_listing->images[0]->url, $product_listing->name, $product_listing->description, (float)$product_listing->price / 100.0, $product_listing->stock);
}
