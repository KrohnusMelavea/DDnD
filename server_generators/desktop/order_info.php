...
function generate_order_info($order_info, $unique_quantity, $quantity, $price) {
 ...
 return sprintf($order_info_template, $order_info->uuid, $order_info->order_date, get_order_status_enum_string($order_info->status), $order_info->address, $quantity, $unique_quantity, $price);
}
