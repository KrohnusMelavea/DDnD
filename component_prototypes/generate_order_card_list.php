...
/*str*/ function generate_order_card_list(/*{{dtm,dtm,int},{str,str,str,int,int,int,dtm}[]}*/$order_card_list_info, /*int*/$order_cards_per_section) {
 ...
 for ($i = 0; $i < count($order_card_infos_split); ++$i) {
  $order_card_list_sections = $order_card_list_sections . generate_order_card_list_section(
   $order_card_infos_split[$i], $i, count($order_card_infos_split));
 }
