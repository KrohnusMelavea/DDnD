...
/*str*/ function generate_order_card(/*str*/$product_url, /*str*/$product_image_url, /*str*/$product_title, /*int*/$price_cents, /*int*/$quantity, /*int*/$order_status) {
    ...
    return sprintf($order_card_template, $product_url, $product_image_url, $product_title, (float)$price_cents / 100.0, $quantity, (float)$price_cents / 100.0 * $quantity, $order_status_class, $order_status_text);
}
